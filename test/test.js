...
test('Convert JSX to JS', function(t){
  ...
  jsxhint.transformJSX('./fixtures/test_article_without_pragma.js', { '--6to5': true, '--force-transform': true }, function(err, data){
    t.ifError(err);
...
test('JSX transpiler error should look like JSHint output, instead of crashing', function(t){
  ...
  jsxhint_proc = child_process.fork('../cli', ['--6to5', '--acorn-column-1', 'fixtures/test_malformed.jsx'], {silent: true});
